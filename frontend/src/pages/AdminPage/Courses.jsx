        ...
        <div className="space-y-6">
            ...
            {showForm && (
                <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/50 p-4 overflow-y-auto" onClick={() => resetForm()} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); resetForm(); } }} role="button" tabIndex={0}>
                    <div className="w-full max-w-3xl rounded-xl bg-white shadow-pop my-8" onClick={e => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-end pb-2.5">
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        <input
                                            ...
                                            className="size-4 text-gray-700 focus:ring-amber-500/50 rounded"
                                        />
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <input type="file" accept="image/*" onChange={handleFileChange} className="text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-gray-100 file:text-gray-800 hover:file:bg-gray-100" />
                                    {thumbnailPreview && (
