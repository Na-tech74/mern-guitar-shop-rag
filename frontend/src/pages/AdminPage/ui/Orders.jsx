                                    ...
                                    <td className="py-3 text-right">
                                        <div className="flex items-center justify-end gap-2">
                                            ...
                                            {order.status === "pending" && (
                                                <>
                                                    <Button variant="ghost" size="sm" onClick={() => updateStatus(order._id, "processing")}>
                                                        <FontAwesomeIcon icon={faCheck} className="text-blue-600" />
                                                    </Button>
                                                    <Button variant="ghost" size="sm" onClick={() => updateStatus(order._id, "cancelled")}>
                                                        <FontAwesomeIcon icon={faXmark} className="text-red-600" />
                                                    </Button>
                                                </>
                                            )}
                                            {order.status === "processing" && (
                                                <Button variant="ghost" size="sm" onClick={() => updateStatus(order._id, "shipped")}>
                                                    <FontAwesomeIcon icon={faTruck} className="text-purple-600" />
                                                </Button>
                                            )}
                                            {order.status === "shipped" && (
                                                <Button variant="ghost" size="sm" onClick={() => updateStatus(order._id, "delivered")}>
