...
const ImageUploader = ({ value, onChange, alt = "" }) => {
    ...
    if (uploading) {
        return (
            <div className="flex h-32 w-full items-center justify-center rounded-lg border-2 border-dashed border-amber-300 bg-amber-50 text-amber-700 text-sm">
    ...
    if (!value) {
        return (
            <div>
                <label className="flex h-32 w-full cursor-pointer items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 text-gray-500 text-sm hover:border-amber-500 hover:bg-amber-50 transition-colors">
                    <input
                        ref={inputRef}
                        type="file"
                        accept="image/*"
...
const VideoUploader = ({ value, onChange, label = "Video" }) => {
    ...
    if (uploading) {
        return (
            <div className="flex h-40 w-full items-center justify-center rounded-lg border-2 border-dashed border-amber-300 bg-amber-50 text-amber-700 text-sm">
    ...
    if (!value) {
        return (
            <div>
                <label className="flex h-40 w-full cursor-pointer items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 text-gray-500 text-sm hover:border-amber-500 hover:bg-amber-50 transition-colors">
                    <input
                        ref={inputRef}
                        type="file"
                        accept="video/*"
    ...
    return (
        <div>
            ...
            <div className="mt-2 flex items-center justify-between gap-2 flex-wrap">
                <label className="inline-flex items-center gap-1 text-xs text-amber-600 hover:text-amber-700 cursor-pointer">
                    <FontAwesomeIcon icon={faUpload} />
                    Thay video khác
                    <input
                        ref={inputRef}
            ...
            <div className="flex items-center justify-between flex-wrap gap-3">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                        <FontAwesomeIcon icon={faHouse} className="text-amber-600" />
                        Quản lý Trang chủ
                    </h1>
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-lg outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 bg-white"
                            >
                                {iconOptions.map((opt) => (
