...
const statusConfig = [
    { key: "pending", label: "Chờ xử lý", icon: faClock, color: "bg-amber-500" },
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <div className="rounded-xl bg-white p-6 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        {recentOrders.length > 0 && (
                            <Link to="/admin/orders" className="text-sm text-gray-700 hover:text-amber-500 flex items-center gap-1">
                ...
                <div className="rounded-xl bg-white p-6 shadow-sm">
                            ...
                            (() => {
                                ...
                                return dayNames.map((day, i) => (
                                    <div key={i} className="flex flex-col items-center flex-1">
                                        ...
                                        <div
                                            className="w-full max-w-[32px] rounded-t-md bg-amber-500 hover:bg-amber-600 transition-colors"
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center">
                        ...
                        <span className="text-xl font-bold text-gray-700">{formatCurrency(totalRevenue)}</span>
                    </div>
                </div>
            </div>
        </div>
